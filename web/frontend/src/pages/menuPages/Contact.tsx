    ...
    <div className="flex flex-col items-center bg-gray-100 min-h-screen">
      ...
      <main className="flex flex-col items-center text-gray-800 px-6 py-12 w-full sm:w-4/5 lg:w-3/4">
        <section className="w-full mb-12">
          ...
          <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-8 space-y-6 w-full sm:w-2/3">
            <div>
            ...
            {formStatus && (
              <div className="mt-4 text-center">
                <p className={formStatus === 'Message sent successfully!' ? 'text-green-500' : 'text-red-500'}>
                  {formStatus}
                </p>
              </div>
            )}
        ...
        <section className="w-full sm:w-2/3 text-center">
          ...
          <p className="text-lg text-gray-700 mb-2">Email: <span className="font-semibold">support@siftly.com</span></p>
          <p className="text-lg text-gray-700 mb-2">Phone: <span className="font-semibold">+1 (123) 456-7890</span></p>
          <p className="text-lg text-gray-700 mb-4">Address: <span className="font-semibold">1234 Siftly St., Example City, 56789</span></p>
        </section>
      </main>
