...
type CookieProps = {
  onAccept: () => void; // Define the type for onAccept prop
  onDecline: () => void; // Define the type for onDecline prop
};

const Cookie: React.FC<CookieProps> = ({ onAccept, onDecline }) => {
  ...
  return (
    <div className="fixed bottom-10 right-10 w-[380px] z-50 bg-white border border-gray-300 rounded-3xl shadow-lg p-6">
      ...
      <div className="flex justify-between">
        ...
        <button
          ...
          className="bg-gray-300 text-gray-800 rounded px-4 py-2 hover:bg-gray-500"
        >
          Decline
        </button>
      </div>
